...
const SHEET_INDEX_ACMI = 1;
const SHEET_INDEX_ACMI_1547 = 2;
const SHEET_INDEX_ACES = 3;
const SHEET_INDEX_ACES_1547 = 4;
const SHEET_INDEX_MOW = 5;

const EMS_DB_COLUMN_NAME_ACMI_TAB = "W";
const EMS_DB_COLUMN_NAME_ACMI_1547_TAB = "T";
const EMS_DB_COLUMN_NAME_ACES_TAB = "X";
const EMS_DB_COLUMN_NAME_ACES_1547_TAB = "U";
...
const SHEET_DB_COLUMN_MAP = [
    ...
    {
        sheet: SHEET_INDEX_ACES_1547,
        column: EMS_DB_COLUMN_NAME_ACES_1547_TAB
    },
    {
...
const GRID_CODE_LIST = [
    ...
    new GridCode(8403, SHEET_INDEX_ACES, "K"),
    new GridCode(8404, SHEET_INDEX_ACES, "L"),
    new GridCode(8406, SHEET_INDEX_ACES, "M"),

    new GridCode(8402, SHEET_INDEX_ACES_1547, "J"),
