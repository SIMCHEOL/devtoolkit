...
const GRID_CODE_LIST = [
    ...
    new GridCode(826, defines.production_MOW, 5000, "R"),
    new GridCode(8262, defines.production_MOW, 5000, "S"),
    new GridCode(372, defines.production_MOW, 5000, "T"),
    // new GridCode(392, defines.production_MOW, 5000, "V"),
